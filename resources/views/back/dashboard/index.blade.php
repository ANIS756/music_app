                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <img src="{{asset('/')}}back/assets/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap">
                            ...
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="{{asset('/')}}back/assets/images/product/img-7.png" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
                            ...
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="{{asset('/')}}back/assets/images/product/img-4.png" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
