                ...
                <div class="album_inner_list">
                    <div class="slider_heading_wrap marger_bottom30">
                        <div class="slider_cheading">
                            <h4 class="cheading_title">Free Downloads &nbsp;</h4>
                        </div>
                    </div>
                    <div class="album_list_wrapper">
                        ...
                        <ul class="play_active_song">
                            ...
                            <li><a href="javascript:;">Bloodlust</a></li>
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Desired Games</a></li>
                            <li><a href="javascript:;">Dream Your Moments</a></li>
                            <li class="text-center"><a href="javascript:;">5:26</a></li>
                            <li class="text-center">
                                <a href="javascript:;">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Dark Alley Acoustic</a></li>
                            <li><a href="javascript:;">Dream Your Moments</a></li>
                            <li class="text-center"><a href="javascript:;">5:26</a></li>
                            <li class="text-center">
                                <a href="javascript:;">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Walking Promises</a></li>
                            <li><a href="javascript:;">Dream Your Moments</a></li>
                            <li class="text-center"><a href="javascript:;">5:26</a></li>
                            <li class="text-center">
                                <a href="javascript:;">
