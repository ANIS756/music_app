        ...
        <div class="ms_music_inner">
            <div class="ms_music_row">
                <div class="ms_music_left">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="music_center_mainbox text-center">
                                        <div class="music_center_img">
                                            <img src="{{asset('/')}}front/assets/images/music/01.jpg" alt="music" class="img-fluid">
                                        </div>
                                        <div class="music_center_info">
                                            <a href="javascript:void(0);" class="music_center_title">Don’t Let me down</a>
                                            <p class="music_center_sub"> Harry Jackson, Virginia Harris</p>
                                            <div class="music_center_details">
                                                <a class="ms_btn" href="javascript:void(0);"> Play All</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="music_center_mainbox text-center">
                                        <div class="music_center_img">
                                            <img src="{{asset('/')}}front/assets/images/music/02.jpg" alt="music" class="img-fluid">
                                        </div>
                                        <div class="music_center_info">
                                            <a href="javascript:void(0);" class="music_center_title">Walking Promises</a>
                                            <p class="music_center_sub"> David Parker, Virginia Harris</p>
                                            <div class="music_center_details">
                                                <a class="ms_btn" href="javascript:void(0);"> Play All</a>
                                                <span class="music_center_dwld">
                                                        <i class="center_dwld_icon"></i>
                                ...
                                <div class="swiper-slide">
                                    <div class="music_center_mainbox text-center">
                                        <div class="music_center_img">
                                            <img src="{{asset('/')}}front/assets/images/music/03.jpg" alt="music" class="img-fluid">
                                        </div>
                                        <div class="music_center_info">
                                            <a href="javascript:void(0);" class="music_center_title"> Desired Games</a>
                                            <p class="music_center_sub"> Kevin Buckland, Carl Brown</p>
                                            <div class="music_center_details">
                                                <a class="ms_btn" href="javascript:void(0);"> Play All</a>
                                                <span class="music_center_dwld">
                                                        <i class="center_dwld_icon"></i>
                    ...
                    <h2 class="music_listwrap_tttl">David Parker Songs ( 05 Songs )</h2>
                ...
                <div class="ms_music_right">
                    <!-- You may also like section -->
                    <div class="ms_artist_slider also_like_slider ms_artist_slider_topspace">
                        <div class="slider_heading_wrap">
                            <div class="slider_cheading">
                                <h4 class="cheading_title">You may also like &nbsp;</h4>
                            </div>
                            <!-- Add Arrows -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="slider_cbox slider_artist_box text-center">
                                            ...
                                            <div class="slider_ctext slider_artist_text">
                                                ...
                                                <p class="slider_cdescription slider_artist_des">2015</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="slider_cbox slider_artist_box text-center">
                                            ...
                                            <div class="slider_ctext slider_artist_text">
                                                <a class="slider_ctitle slider_artist_ttl" href="javascript:void(0)">Don’t Let me down</a>
                                                <p class="slider_cdescription slider_artist_des">2020</p>
                                            </div>
                                        </div>
                                    </div>
